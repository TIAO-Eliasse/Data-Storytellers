...
![HTML](https://img.shields.io/badge/HTML-3572A5?logo=html&logoColor=white) ![React](https://img.shields.io/badge/React-informational?style=flat) ![Vite](https://img.shields.io/badge/Vite-informational?style=flat) 

---

## 📌 Overview

This repository contains the full source code and experimental pipeline for Data-Storytellers. The objective of this project is to address complex challenges in Machine Learning / Analytics by leveraging modern state-of-the-art frameworks.

The methodology primarily utilizes React, Vite to ensure scalable and accurate modeling. Careful attention was paid to the preprocessing pipeline and evaluation metrics to ensure that the results are statistically sound and practically viable.
